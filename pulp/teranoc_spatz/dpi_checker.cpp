...
/*
 * Description: GVSoC native checker for the TeraNoC DPI check ABI.
...
bool MempoolDpiChecker::check_fp_error(float result, float expected, float tolerance) {
...
void MempoolDpiChecker::read_l2_bytes(uint64_t addr, size_t length, std::vector<uint8_t> &buffer)
{
