...
from pulp.teranoc_spatz.teranoc_group import TeranocGroup
from pulp.teranoc_spatz.l2_interconnect.l2_address_scrambler import L2AddressScrambler
from pulp.teranoc_spatz.l1_interconnect.l1_noc import L1_noc
    ...
    def __init__(self, parent, name, parser, arch):
        ...
        for i in range(0, arch.nb_inter_group_ports_per_group):
            self.l1_req_noc_list.append(L1_noc(self, f'l1_req_noc_{i}', width=arch.l1_bank_width,
                ...
                max_burst_size=(arch.vlsu_burst.max_burst_words * 4
                    if arch.vlsu_burst.fabric_enable else 0)))
